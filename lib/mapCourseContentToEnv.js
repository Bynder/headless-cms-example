function mapCourseContentToEnv(data) {
  return {
    ...
    coreRequisites: data[process.env.CONTENT_CORE_REQUISITES_FIELD_UUID] || null,
    ...
    heroImageUrl: data[process.env.CONTENT_HERO_IMAGE_FIELD_UUID] && data[process.env.CONTENT_HERO_IMAGE_FIELD_UUID][0]?.url || null,
  }
}
